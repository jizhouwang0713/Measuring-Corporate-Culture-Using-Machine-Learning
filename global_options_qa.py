...
DATA_FOLDER: str = "data_qa/"
MODEL_FOLDER: str = "models_qa/" # will be created if does not exist
OUTPUT_FOLDER: str = "outputs_qa/" # will be created if does not exist; !!! WARNING: existing files will be removed !!!
