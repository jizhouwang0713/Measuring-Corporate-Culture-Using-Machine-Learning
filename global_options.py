...
RAM_CORENLP: str = "64G"  # max RAM allocated for parsing using CoreNLP; increase to speed up parsing
PARSE_CHUNK_SIZE: int = 500 # number of lines in the input file to process uing CoreNLP at once. Increase on workstations with larger RAM (e.g. to 1000 if RAM is 64G)  

# Directory locations
os.environ[
    "CORENLP_HOME"
] = "C:/Users/jizhouw0/stanford-corenlp-4.5.0/"  # location of the CoreNLP models; use / to seperate folders
